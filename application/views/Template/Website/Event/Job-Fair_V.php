			...
			<div class="row justify-content-center d-flex">
				<div class="col-lg-8 post-list">
					...
					<div class="single-post d-flex flex-row">
						<div class="thumb">
							<img src="img/post.png" alt="" style="padding-right : 30px;">
						</div>
						<div class="details">
							<div class="title d-flex flex-row justify-content-between">
								<div class="titles">
									<a href="single.html"><h4>Nama Events</h4></a>
									<h6>Panitia Events</h6>					
								</div>
								<ul class="btns">
							...
							<p>
								(Deskripsi Events)Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod temporinc ididunt ut dolore magna aliqua.
							</p>
							<!-- <hr> -->
							<p class="address"><span class="lnr lnr-calendar-full"></span> Tanggal</p>
							<p class="address"><span class="lnr lnr-clock"></span> Jam</p>
							<p class="address"><span class="lnr lnr-map-marker"></span> Alamat</p>
						</div>
					</div>
					...
					<div class="single-post d-flex flex-row">
						...
						<div class="details">
							...
							<!-- <hr> -->
							<p class="address"><span class="lnr lnr-map"></span> Tanggal</p>
							<p class="address"><span class="lnr lnr-database"></span> Jam</p>
							<p class="address"><span class="lnr lnr-database"></span> Alamat</p>
						</div>
					</div>
