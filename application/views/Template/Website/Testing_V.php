...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo base_url().'assets/website/summernote/bootstrap.css';?>">
...
<body>
	...
	<script type="text/javascript" src="<?php echo base_url().'assets/website/summernote/jquery-3.4.0.min.js';?>"></script>
	<script type="text/javascript" src="<?php echo base_url().'assets/website/summernote/bootstrap.bundle.js';?>"></script>
