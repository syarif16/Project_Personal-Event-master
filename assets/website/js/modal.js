(function ($) {
    ...
    $(".animated-swing-clavest, .modal-swing").addClass("swing animated");
    $(".animated-bounce-up-clavest, .modal-bounceInUp").addClass("bounceInUp animated");
    $(".animated-shake-clavest, .modal-shake").addClass("shake animated");
